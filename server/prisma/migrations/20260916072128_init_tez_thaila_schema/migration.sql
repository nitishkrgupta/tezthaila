...
CREATE TABLE `Order` (
    ...
    `orderStatus` ENUM('ORDER_PLACED', 'CONFIRMED', 'PACKED', 'SHIPPED', 'OUT_FOR_DELIVERY', 'DELIVERED', 'CANCELLED', 'RETURN_REQUESTED', 'RETURNED', 'REFUNDED') NOT NULL DEFAULT 'ORDER_PLACED',
...
CREATE TABLE `ReturnRequest` (
    ...
    `description` TEXT NULL,
    `status` ENUM('REQUESTED', 'APPROVED', 'REJECTED', 'PICKUP_SCHEDULED', 'RECEIVED', 'REFUNDED') NOT NULL DEFAULT 'REQUESTED',
